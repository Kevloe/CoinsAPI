...
public class MySQL {
  ...
  public static String host =
      CoinAPI.getInstance().getMysqlconfig().getCfg().getString("MySQL.Host");
  public static String port =
      CoinAPI.getInstance().getMysqlconfig().getCfg().getString("MySQL.Port");
  public static String database =
      CoinAPI.getInstance().getMysqlconfig().getCfg().getString("MySQL.Database");
  public static String username =
      CoinAPI.getInstance().getMysqlconfig().getCfg().getString("MySQL.Username");
  public static String password =
      CoinAPI.getInstance().getMysqlconfig().getCfg().getString("MySQL.Password");
